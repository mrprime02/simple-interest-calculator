...
function App() {
  ...
  const [validPrincple,setValidPrinciple] = useState(true)
    ...
    <div style={{width:'100%',height:'100vh'}} className='d-flex justify-content-center align-items-center bg-dark'> 
      <div style={{width:'600px'}} className='bg-light p-5 rounded'>
        ...
        <form className='mt-5' onSubmit={handleCalculate}>
          ...
          { !validPrincple&&<div className="mb-3 text-danger fw-bolder">Invalid Principle Amount</div>}
          <div className="mb-3">
          ...
          <Button type='submit' style={{height:'70px',width:'50%'}} className='bg-dark' variant="contained" disabled={validPrincple&&validRate&&validYear?false:true}>CALCULATE</Button>
          <Button  onClick={handleReset} style={{height:'70px',width:'50%'}} className='bg-dark' variant="outlined" >RESET</Button>
          </Stack>
        </form>
        </div>
    </div>
